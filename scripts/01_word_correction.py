...
def load_vocab(file_path):
    with open(file_path, 'r') as f:
        lines = f.readlines()
    # get a set of words with no space, no capital characters, sort in alphabet order
...
def main_python():
    ...
    print('sorted_distences', sorted_distences)
...
if __name__ == "__main__":
    ...
    vocabs = load_vocab(
        file_path='/Users/nguyendung/git/streamlit_example/data/vocab.txt')
    print('vocabs', vocabs)
    # main_python()
    main()
